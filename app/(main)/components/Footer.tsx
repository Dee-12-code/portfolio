...
const socialLinks = [
  {
    name: 'WhatsApp',
    url: 'https://wa.me/+2348065170569', // Replace with your WhatsApp link
    icon: (
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/in/oladeji-johnson-137aa1332', // Replace with your LinkedIn
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
  ...
  {
    name: 'GitHub',
    url: 'https://github.com/dee-12-code', // Replace with your GitHub
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
  ...
  {
    name: 'Email',
    url: 'mailto:dejij4617@gmail.com', // Replace with your email
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
